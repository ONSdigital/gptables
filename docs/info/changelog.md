...
* Accessibility checklist based on [Analysis Function guidance](https://analysisfunction.civilservice.gov.uk/policy-store/making-spreadsheets-accessible-a-brief-checklist-of-the-basics/) and [a11ytables documentation](https://co-analysis.github.io/a11ytables/articles/checklist.html)
