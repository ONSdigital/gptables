...
This page provides examples of gptables in use with real data processes.

If you'd like your work featured here, reach out to us at ASAP@ons.gov.uk!
...
??? "Labour market overview tables code"
    ```python
